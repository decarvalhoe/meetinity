"""Authentication helpers for the messaging service."""
...
def get_authenticated_user_id(request: Request) -> int:
    """Return the authenticated user id from the Authorization header."""
...
def _extract_user_id(token: str) -> int | None:
    ...
    # Accept JWT-like tokens where the subject id is provided as the last segment.
